...
#endif
void wolfSSL_echoServer_test(const osuCryptoNew::CLP& cmd)
{
#ifdef ENABLE_WOLFSSL
...
void wolfSSL_mutualAuth_test(const osuCryptoNew::CLP& cmd)
{
#ifdef ENABLE_WOLFSSL
...
void wolfSSL_channel_test(const osuCryptoNew::CLP& cmd)
{
#ifdef ENABLE_WOLFSSL
