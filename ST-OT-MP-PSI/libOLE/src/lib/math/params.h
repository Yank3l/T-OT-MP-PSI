...
namespace lbcrypto {
    ...
    struct fast_four_limb_reduction_params {
        ...
        // static constexpr value_type Pn[kMaxNbModuli] = {16941902124300ULL, 33883804248464ULL, 67767608494882ULL, 135535216981573ULL};
        ...
        //DCRT for plaintext
        static constexpr value_type P_p[kMaxNbModuli] = {2820882433ULL, 2183135233ULL, 3997745153ULL, 4294475777ULL};
    } __attribute__((aligned(32)));
