...
constexpr ui64 fast_four_limb_reduction_params::P[4];
constexpr ui64 fast_four_limb_reduction_params::Pn[4];
constexpr ui64 fast_four_limb_reduction_params::PrimitiveMthRoots[4];
constexpr ui32 fast_four_limb_reduction_params::bitSizes[4];
constexpr ui64 fast_four_limb_reduction_params::P_p[4];
